...
author: "IFPRI/CIAT"
date:   "December, 2015. Last updated on `r Sys.Date()`"
output:
  html_document:
    fig_height: 8
    fig_width: 8
...
setwd("~/Dropbox (IFPRI)/SDA/Projects/2016-Semantics")

# Load data snapshot
load("./tmp/GoogleScholarCGIAR.RData")
...
# Start scraping from root author down through its CGIAR co-authors
...
save.image("./tmp/GoogleScholarCGIAR.RData")

```

```{r rpubs, eval=F, echo=F}

# Knit and upload to RPubs
require(rsconnect)
require(knitr)

knit("./R/GoogleScholarCGIAR.Rmd", "./R/GoogleScholarCGIAR.html")
res <- rpubsUpload("CGIAR-Authors", "./R/GoogleScholarCGIAR.html", "./R/GoogleScholarCGIAR.Rmd")
if (!is.null(res$continueUrl)) browseURL(res$continueUrl) else stop(res$error)
rpubsUpload("CGIAR-Authors", "./R/GoogleScholarCGIAR.html", "./R/GoogleScholarCGIAR.Rmd", id=res$id)
